...
#define CAMPAIGN_STATE_NEUTRAL_FLAG 0x00
#define CAMPAIGN_STATE_FAILED_FUND_RAISE_FLAG 0x01
#define CAMPAIGN_STATE_FAILED_MILESTONE_FLAG 0x02

// Milestone state flags
#define MILESTONE_STATE_NEUTRAL_FLAG  0x00
