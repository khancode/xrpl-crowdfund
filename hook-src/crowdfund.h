...
#define MODE_CREATE_CAMPAIGN_PART_A_FLAG 0x00
#define MODE_CREATE_CAMPAIGN_PART_B_FLAG 0x01
#define MODE_FUND_CAMPAIGN_FLAG 0x02
#define MODE_VOTE_REJECT_FLAG 0x03
#define MODE_VOTE_APPROVE_FLAG 0x04
#define MODE_REQUEST_REFUND_PAYMENT_FLAG 0x05
#define MODE_REQUEST_MILESTONE_PAYOUT_PAYMENT_FLAG 0x06
...
#define GENERAL_INFO_BUFFER_LENGTH 158

#define CREATE_CAMPAIGN_DEPOSIT_IN_DROPS 1300000000

// Payload validation
#define XRP_ADDRESS_MAX_BYTES 35
#define TITLE_MAX_BYTES 75
#define DESCRIPTION_MAX_BYTES 2500
#define OVERVIEW_URL_MAX_BYTES 2300
...
#define DATA_LOOKUP_GENERAL_INFO_FLAG ((uint8_t[DATA_LOOKUP_FLAG_BYTES]){ \
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00})
#define DATA_LOOKUP_DESCRIPTION_FRAGMENT_START_INDEX_FLAG ((uint8_t[DATA_LOOKUP_FLAG_BYTES]){ \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x01})
#define DATA_LOOKUP_DESCRIPTION_FRAGMENT_END_INDEX_FLAG ((uint8_t[DATA_LOOKUP_FLAG_BYTES]){ \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x0A})
#define DATA_LOOKUP_OVERVIEW_URL_FRAGMENT_START_INDEX_FLAG ((uint8_t[DATA_LOOKUP_FLAG_BYTES]){ \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x0B})
#define DATA_LOOKUP_OVERVIEW_URL_FRAGMENT_END_INDEX_FLAG ((uint8_t[DATA_LOOKUP_FLAG_BYTES]){ \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x13})
#define DATA_LOOKUP_MILESTONES_PAGE_START_INDEX_FLAG ((uint8_t[DATA_LOOKUP_FLAG_BYTES]){ \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x14})
#define DATA_LOOKUP_MILESTONES_PAGE_END_INDEX_FLAG ((uint8_t[DATA_LOOKUP_FLAG_BYTES]){ \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
    0x00, 0x00, 0x00, 0x18})
...
#define GET_DATA_LOOKUP_PAGE_FLAG_USING_MILESTONE_INDEX(milestone_index, result_data_lookup_page_flag, result_page_slot_index) { \
    uint32_t page_index = (milestone_index / HOOK_STATE_MILESTONES_PAGE_SIZE); \
    (result_page_slot_index) = (milestone_index % HOOK_STATE_MILESTONES_PAGE_SIZE); \
    ADD_UINT32_TO_ARRS_28(DATA_LOOKUP_MILESTONES_PAGE_START_INDEX_FLAG, page_index, result_data_lookup_page_flag); \
}
