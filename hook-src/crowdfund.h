...
#define MODE_DEV_CREATE_CAMPAIGN_FLAG 0x06
#define MODE_DEV_FUND_CAMPAIGN_FLAG 0x07
#define MODE_DEV_VOTE_REJECT_MILESTONE_FLAG 0x08
#define MODE_DEV_VOTE_APPROVE_MILESTONE_FLAG 0x09
